...
/*
SELECT 'person.business_entity';
\copy person.business_entity FROM './business_entity.csv' DELIMITER '	' CSV;
...
SELECT 'person.business_entityAddress';
\copy person.business_entityAddress FROM './business_entityAddress.csv' DELIMITER '	' CSV;
SELECT 'person.ContactType';
\copy person.ContactType FROM './ContactType.csv' DELIMITER '	' CSV;
SELECT 'person.business_entityContact';
\copy person.business_entityContact FROM './business_entityContact.csv' DELIMITER '	' CSV;
...
/*
SELECT 'human_resources.Department';
\copy human_resources.Department FROM './Department.csv' DELIMITER '	' CSV;
SELECT 'human_resources.Employee';
\copy human_resources.Employee FROM './Employee.csv' DELIMITER '	' CSV;
SELECT 'human_resources.EmployeeDepartmentHistory';
\copy human_resources.EmployeeDepartmentHistory FROM './EmployeeDepartmentHistory.csv' DELIMITER '	' CSV;
SELECT 'human_resources.EmployeePayHistory';
\copy human_resources.EmployeePayHistory FROM './EmployeePayHistory.csv' DELIMITER '	' CSV;
SELECT 'human_resources.JobCandidate';
\copy human_resources.JobCandidate FROM './JobCandidate.csv' DELIMITER '	' CSV ENCODING 'latin1';
SELECT 'human_resources.Shift';
\copy human_resources.Shift FROM './Shift.csv' DELIMITER '	' CSV;
*/
...
--  COMMENT ON COLUMN sales.SalesOrderDetail.LineTotal IS 'Per product subtotal. Computed as unit_price * (1 - unit_price_discount) * order_qty.';
...
--  COMMENT ON COLUMN production.WorkOrder.stocked_qty IS 'Quantity built and put in inventory.';
...
ALTER TABLE person.business_entity ADD
    CONSTRAINT "pk_business_entity_business_entity_id" PRIMARY KEY
    (business_entity_id);
CLUSTER person.business_entity USING "pk_business_entity_business_entity_id";

ALTER TABLE person.business_entity_address ADD
    CONSTRAINT "pk_business_entity_address_business_entity_id_address_id_address_type" PRIMARY KEY
...
ALTER TABLE person.business_entity_contact ADD
    CONSTRAINT "pk_business_entity_contact_business_entity_id_person_id_contact_type_i" PRIMARY KEY
...
ALTER TABLE person.email_address ADD
    CONSTRAINT "pk_email_address_business_entity_id_email_address_id" PRIMARY KEY
...
ALTER TABLE human_resources.employee_department_history ADD
    CONSTRAINT "pk_employee_department_history_business_entity_id_start_date_departm" PRIMARY KEY
...
ALTER TABLE human_resources.employee_pay_history ADD
    CONSTRAINT "pk_employee_pay_history_business_entity_id_rate_change_date" PRIMARY KEY
...
ALTER TABLE person.password ADD
    CONSTRAINT "pk_password_business_entity_id" PRIMARY KEY
    (business_entity_id);
CLUSTER person.password USING "pk_password_business_entity_id";

ALTER TABLE person.person ADD
    CONSTRAINT "pk_person_business_entity_id" PRIMARY KEY
    (business_entity_id);
CLUSTER person.person USING "pk_person_business_entity_id";

ALTER TABLE person.person_phone ADD
    CONSTRAINT "pk_person_phone_business_entity_id_phone_number_phone_number_type_id" PRIMARY KEY
...
ALTER TABLE production.product_model_illustration ADD
    CONSTRAINT "pk_product_model_illustration_product_model_id_illustration_id" PRIMARY KEY
...
ALTER TABLE production.product_model_product_description_culture ADD
    CONSTRAINT "pk_product_model_product_description_culture_product_model_id_product" PRIMARY KEY
...
ALTER TABLE purchasing.product_vendor ADD
    CONSTRAINT "pk_product_vendor_product_id_business_entity_id" PRIMARY KEY
...
ALTER TABLE purchasing.purchase_order_detail ADD
    CONSTRAINT "pk_purchase_order_detail_purchase_order_id_purchase_order_detail_id" PRIMARY KEY
...
ALTER TABLE sales.person_credit_card ADD
    CONSTRAINT "pk_person_credit_card_business_entity_id_credit_card_id" PRIMARY KEY
...
ALTER TABLE sales.sales_order_header_sales_reason ADD
    CONSTRAINT "pk_sales_order_header_sales_reason_sales_order_id_sales_reason_id" PRIMARY KEY
...
ALTER TABLE sales.sales_person ADD
    CONSTRAINT "pk_sales_person_business_entity_id" PRIMARY KEY
    (business_entity_id);
CLUSTER sales.sales_person USING "pk_sales_person_business_entity_id";

ALTER TABLE sales.sales_person_quota_history ADD
    CONSTRAINT "pk_sales_person_quota_history_business_entity_id_quota_date" PRIMARY KEY
...
ALTER TABLE sales.sales_territory_history ADD
    CONSTRAINT "pk_sales_territory_history_business_entity_id_start_date_territory_id" PRIMARY KEY
...
ALTER TABLE sales.store ADD
    CONSTRAINT "pk_store_business_entity_id" PRIMARY KEY
    (business_entity_id);
...
ALTER TABLE purchasing.vendor ADD
    CONSTRAINT "pk_vendor_business_entity_id" PRIMARY KEY
    (business_entity_id);
...
ALTER TABLE production.work_order_routing ADD
    CONSTRAINT "pk_work_order_routing_work_order_id_product_id_operation_sequence" PRIMARY KEY
...
ALTER TABLE person.address ADD
    CONSTRAINT "fk_address_state_province_state_province_id" FOREIGN KEY
...
-- ALTER TABLE person.business_entity_address ADD
--     CONSTRAINT "fk_business_entity_address_address_address_id" FOREIGN KEY
--     (address_id) REFERENCES person.address(address_id);
ALTER TABLE person.business_entity_address ADD
    CONSTRAINT "fk_business_entity_address_address_type_address_type_id" FOREIGN KEY
    (address_type_id) REFERENCES person.address_type(address_type_id);
ALTER TABLE person.business_entity_address ADD
    CONSTRAINT "fk_business_entity_address_business_entity_business_entity_id" FOREIGN KEY
    (business_entity_id) REFERENCES person.business_entity(business_entity_id);

ALTER TABLE person.business_entity_contact ADD
    CONSTRAINT "fk_business_entity_contact_person_person_id" FOREIGN KEY
    (person_id) REFERENCES person.person(business_entity_id);
ALTER TABLE person.business_entity_contact ADD
    CONSTRAINT "fk_business_entity_contact_contact_type_contact_type_id" FOREIGN KEY
    (contact_type_id) REFERENCES person.contact_type(contact_type_id);
ALTER TABLE person.business_entity_contact ADD
    CONSTRAINT "fk_business_entity_contact_business_entity_business_entity_id" FOREIGN KEY
    (business_entity_id) REFERENCES person.business_entity(business_entity_id);
...
ALTER TABLE person.email_address ADD
    CONSTRAINT "fk_email_address_person_business_entity_id" FOREIGN KEY
    (business_entity_id) REFERENCES person.person(business_entity_id);

ALTER TABLE human_resources.employee ADD
    CONSTRAINT "fk_employee_person_business_entity_id" FOREIGN KEY
    (business_entity_id) REFERENCES person.person(business_entity_id);

ALTER TABLE human_resources.employee_department_history ADD
    CONSTRAINT "fk_employee_department_history_department_department_id" FOREIGN KEY
    (department_id) REFERENCES human_resources.department(department_id);
ALTER TABLE human_resources.employee_department_history ADD
    CONSTRAINT "fk_employee_department_history_employee_business_entity_id" FOREIGN KEY
    (business_entity_id) REFERENCES human_resources.employee(business_entity_id);
ALTER TABLE human_resources.employee_department_history ADD
    CONSTRAINT "fk_employee_department_history_shift_shift_id" FOREIGN KEY
    (shift_id) REFERENCES human_resources.shift(shift_id);

ALTER TABLE human_resources.employee_pay_history ADD
    CONSTRAINT "fk_employee_pay_history_employee_business_entity_id" FOREIGN KEY
    (business_entity_id) REFERENCES human_resources.employee(business_entity_id);

ALTER TABLE human_resources.job_candidate ADD
    CONSTRAINT "fk_job_candidate_employee_business_entity_id" FOREIGN KEY
    (business_entity_id) REFERENCES human_resources.employee(business_entity_id);

ALTER TABLE person.password ADD
    CONSTRAINT "fk_password_person_business_entity_id" FOREIGN KEY
    (business_entity_id) REFERENCES person.person(business_entity_id);

ALTER TABLE person.person ADD
    CONSTRAINT "fk_person_business_entity_business_entity_id" FOREIGN KEY
    (business_entity_id) REFERENCES person.business_entity(business_entity_id);

ALTER TABLE sales.person_credit_card ADD
    CONSTRAINT "fk_person_credit_card_person_business_entity_id" FOREIGN KEY
    (business_entity_id) REFERENCES person.person(business_entity_id);
ALTER TABLE sales.person_credit_card ADD
...
ALTER TABLE person.person_phone ADD
    CONSTRAINT "fk_person_phone_person_business_entity_id" FOREIGN KEY
    (business_entity_id) REFERENCES person.Person(business_entity_id);
ALTER TABLE person.person_phone ADD
...
ALTER TABLE production.product_model_product_description_culture ADD
    CONSTRAINT "fk_product_model_product_description_culture_product_description_pro" FOREIGN KEY
    (product_description_id) REFERENCES production.product_description(product_description_id);
ALTER TABLE production.product_model_product_description_culture ADD
    CONSTRAINT "fk_product_model_product_description_culture_culture_culture_id" FOREIGN KEY
    (culture_id) REFERENCES production.culture(culture_id);
-- Key (productmodelid)=(1) is not present in table "productmodel"
-- ALTER TABLE production.product_model_product_description_culture ADD
--     CONSTRAINT "fk_product_model_product_description_culture_product_model_product_mo" FOREIGN KEY
--     (product_model_id) REFERENCES production.product_model(product_model_id);
...
ALTER TABLE purchasing.product_vendor ADD
    ...
    (unit_measure_code) REFERENCES production.unit_measure(unit_measure_code);
ALTER TABLE purchasing.product_vendor ADD
    CONSTRAINT "fk_product_vendor_vendor_business_entity_id" FOREIGN KEY
...
ALTER TABLE purchasing.purchase_order_detail ADD
    ...
    (product_id) REFERENCES production.product(product_id);
ALTER TABLE purchasing.purchase_order_detail ADD
    CONSTRAINT "fk_purchase_order_detail_purchase_order_header_purchase_order_id" FOREIGN KEY
...
ALTER TABLE sales.sales_order_detail ADD
    CONSTRAINT "fk_sales_order_detail_special_offer_product_special_offer_i_dproduct_id" FOREIGN KEY
    (special_offer_id, product_id) REFERENCES sales.special_offer_product(special_offer_id, product_id);

ALTER TABLE sales.sales_order_header ADD
    CONSTRAINT "fk_sales_order_header_address_bill_to_address_id" FOREIGN KEY
    (bill_to_address_id) REFERENCES person.Address(address_id);
ALTER TABLE sales.sales_order_header ADD
    CONSTRAINT "fk_sales_order_header_address_ship_to_address_id" FOREIGN KEY
...
ALTER TABLE sales.sales_order_header_sales_reason ADD
    CONSTRAINT "fk_sales_order_header_sales_reason_sales_reason_sales_reason_id" FOREIGN KEY
    (sales_reason_id) REFERENCES sales.sales_reason(sales_reason_id);
ALTER TABLE sales.sales_order_header_sales_reason ADD
    CONSTRAINT "fk_sales_order_header_sales_reason_sales_order_header_sales_order_id" FOREIGN KEY
    (sales_order_id) REFERENCES sales.sales_order_header(sales_order_id) ON DELETE CASCADE;

ALTER TABLE sales.sales_person ADD
    CONSTRAINT "fk_sales_person_employee_business_entity_id" FOREIGN KEY
    (business_entity_id) REFERENCES human_resources.employee(business_entity_id);
ALTER TABLE sales.sales_person ADD
...
ALTER TABLE sales.sales_person_quota_history ADD
    CONSTRAINT "fk_sales_person_quota_history_sales_person_business_entity_id" FOREIGN KEY
...
ALTER TABLE sales.sales_territory_history ADD
    CONSTRAINT "fk_sales_territory_history_sales_person_business_entity_id" FOREIGN KEY
    (business_entity_id) REFERENCES sales.sales_person(business_entity_id);
ALTER TABLE sales.sales_territory_history ADD
...
ALTER TABLE sales.store ADD
    CONSTRAINT "fk_store_business_entity_business_entity_id" FOREIGN KEY
    (business_entity_id) REFERENCES person.business_entity(business_entity_id);
ALTER TABLE sales.store ADD
...
ALTER TABLE purchasing.vendor ADD
    CONSTRAINT "fk_vendor_business_entity_business_entity_id" FOREIGN KEY
    (business_entity_id) REFERENCES person.business_entity(business_entity_id);
...
-- CREATE VIEW [human_resources].[vJobCandidate]
-- AS
-- SELECT
--     jc.[JobCandidateID]
...
--     ,jc.[modified_date]
-- FROM [human_resources].[JobCandidate] jc
-- CROSS APPLY jc.[Resume].nodes(N'declare default element namespace "http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume";
--     /Resume') AS Resume(ref);

-- CREATE VIEW [human_resources].[vJobCandidateEmployment]
-- AS
-- SELECT
--     jc.[JobCandidateID]
--     ,CONVERT(datetime, REPLACE([Employment].ref.value(N'declare default element namespace "http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume";
--         (Emp.start_date)[1]', 'nvarchar(20)') ,'Z', ''), 101) AS [Emp.start_date]
--     ,CONVERT(datetime, REPLACE([Employment].ref.value(N'declare default element namespace "http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume";
--         (Emp.end_date)[1]', 'nvarchar(20)') ,'Z', ''), 101) AS [Emp.end_date]
...
-- CREATE VIEW [human_resources].[vJobCandidateEducation]
-- AS
-- SELECT
--     jc.[JobCandidateID]
...
--         (Edu.start_date)[1]', 'nvarchar(20)') ,'Z', ''), 101) AS [Edu.start_date]
--     ,CONVERT(datetime, REPLACE([Education].ref.value(N'declare default element namespace "http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume";
--         (Edu.end_date)[1]', 'nvarchar(20)') ,'Z', ''), 101) AS [Edu.end_date]
--     ,[Education].ref.value(N'declare default element namespace "http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/Resume";
...
-- CREATE UNIQUE CLUSTERED INDEX [IX_vProductAndDescription] ON [Production].[vProductAndDescription]([CultureID], [product_id]);
...
--     ,[MfgInstructions].ref.value('@location_id[1]', 'int') AS [location_id]
...
--         ON sp.[business_entity_id] = soh.[SalesPersonID]
--         INNER JOIN [Sales].[SalesTerritory] st
--         ON sp.[TerritoryID] = st.[TerritoryID]
--         INNER JOIN [human_resources].[Employee] e
--         ON soh.[SalesPersonID] = e.[business_entity_id]
--     INNER JOIN [Person].[Person] p
...
-- Convenience views
CREATE SCHEMA hr
  CREATE VIEW d AS SELECT * FROM human_resources.department
  CREATE VIEW e AS SELECT * FROM human_resources.employee
  CREATE VIEW edh AS SELECT * FROM human_resources.employee_department_history
  CREATE VIEW eph AS SELECT * FROM human_resources.employee_pay_history
  CREATE VIEW jc AS SELECT * FROM human_resources.job_candidate
  CREATE VIEW s AS SELECT * FROM human_resources.shift
;
CREATE SCHEMA pe
  CREATE VIEW a AS SELECT * FROM person.address
  CREATE VIEW at AS SELECT * FROM person.address_type
  CREATE VIEW be AS SELECT * FROM person.business_entity
  CREATE VIEW bea AS SELECT * FROM person.business_entity_address
  CREATE VIEW bec AS SELECT * FROM person.business_entity_contact
  CREATE VIEW ct AS SELECT * FROM person.contact_type
  CREATE VIEW cr AS SELECT * FROM person.country_region
  CREATE VIEW e AS SELECT * FROM person.email_address
  CREATE VIEW pa AS SELECT * FROM person.password
  CREATE VIEW p AS SELECT * FROM person.person
  CREATE VIEW pp AS SELECT * FROM person.person_phone
  CREATE VIEW pnt AS SELECT * FROM person.phone_number_type
  CREATE VIEW sp AS SELECT * FROM person.state_province
;
CREATE SCHEMA pr
  CREATE VIEW bom AS SELECT * FROM production.bill_of_materials
  ...
  CREATE VIEW pc AS SELECT * FROM production.product_category
  CREATE VIEW pch AS SELECT * FROM production.product_cost_history
  CREATE VIEW pd AS SELECT * FROM production.product_description
  CREATE VIEW pdoc AS SELECT * FROM production.product_document
  CREATE VIEW pi AS SELECT * FROM production.product_inventory
  CREATE VIEW plph AS SELECT * FROM production.product_list_price_history
  CREATE VIEW pm AS SELECT * FROM production.product_model
  ...
  CREATE VIEW pp AS SELECT * FROM production.product_photo
  CREATE VIEW ppp AS SELECT * FROM production.product_product_photo
  CREATE VIEW pr AS SELECT * FROM production.product_review
  CREATE VIEW psc AS SELECT * FROM production.product_subcategory
  CREATE VIEW sr AS SELECT * FROM production.scrap_reason
  CREATE VIEW th AS SELECT * FROM production.transaction_history
  CREATE VIEW tha AS SELECT * FROM production.transaction_history_archive
  CREATE VIEW um AS SELECT * FROM production.unit_measure
  CREATE VIEW w AS SELECT * FROM production.work_order
  CREATE VIEW wr AS SELECT * FROM production.work_order_routing
;
CREATE SCHEMA pu
  CREATE VIEW pv AS SELECT * FROM purchasing.product_vendor
  CREATE VIEW pod AS SELECT * FROM purchasing.purchase_order_detail
  CREATE VIEW poh AS SELECT * FROM purchasing.purchase_order_header
  CREATE VIEW sm AS SELECT * FROM purchasing.ship_method
  CREATE VIEW v AS SELECT * FROM purchasing.vendor
;
CREATE SCHEMA sa
  CREATE VIEW crc AS SELECT * FROM sales.country_region_currency
  CREATE VIEW cc AS SELECT * FROM sales.credit_card
  ...
  CREATE VIEW pcc AS SELECT * FROM sales.person_credit_card
  CREATE VIEW sod AS SELECT * FROM sales.sales_order_detail
  CREATE VIEW soh AS SELECT * FROM sales.sales_order_header
  CREATE VIEW sohsr AS SELECT * FROM sales.sales_order_header_sales_reason
  CREATE VIEW sp AS SELECT * FROM sales.sales_person
  CREATE VIEW spqh AS SELECT * FROM sales.sales_person_quota_history
  CREATE VIEW sr AS SELECT * FROM sales.sales_reason
  CREATE VIEW tr AS SELECT * FROM sales.sales_tax_rate
  CREATE VIEW st AS SELECT * FROM sales.sales_territory
  CREATE VIEW sth AS SELECT * FROM sales.sales_territory_history
  CREATE VIEW sci AS SELECT * FROM sales.shopping_cart_item
  CREATE VIEW so AS SELECT * FROM sales.special_offer
  CREATE VIEW sop AS SELECT * FROM sales.special_offer_product
